      ...
      <div v-show="activeTab === 'morning'" class="table-card">
        ...
        <table class="custom-table morning-table">
          ...
          <tbody>
            ...
            <tr>
              <td rowspan="4"><EditText v-model="d.morning.out_area" :edit="isEditing" class="h-full" /></td>
              <td><EditText v-model="d.morning.out_hygiene" :edit="isEditing" /></td>
              <td><EditText v-model="d.morning.out_hygiene_names" :edit="isEditing" /></td>
              <td><EditText v-model="d.morning.out_hygiene_work" :edit="isEditing" /></td>
            </tr>
            <tr>
              <td rowspan="3"><EditText v-model="d.morning.out_sweep1" :edit="isEditing" class="h-full"/></td>
              <td><EditText v-model="d.morning.out_sweep1_names" :edit="isEditing" /></td>
              <td rowspan="3"><EditText v-model="d.morning.out_sweep_work" :edit="isEditing" class="h-full" /></td>
            </tr>
            <tr><td><EditText v-model="d.morning.out_sweep2_names" :edit="isEditing" /></td></tr>
            <tr><td><EditText v-model="d.morning.out_sweep3_names" :edit="isEditing" /></td></tr>
          </tbody>
        </table>
...
@media print {
  ...
  .readonly-text { padding: 1px !important; line-height: 1.15 !important; }
