  ...
  <div class="admin-panel">
    ...
    <div class="editor-section">
      ...
      <div class="list-header-row">
        <h4 class="section-title" style="margin: 0; border: none;">📋 現有公告清單</h4>
...
const saveAnnouncement = async () => {
  ...
  try {
    ...
    alert(editingAnnId.value ? '✅ 公告修改成功！' : '✅ 公告發布成功！')
  } catch (err) { 
...
const batchDelete = async () => {
  if (!confirm(`確定要刪除選取的 ${selectedAnns.value.length} 則公告嗎？(刪除後無法復原)`)) return
  isSaving.value = true
